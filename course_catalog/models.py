...
class Course(models.Model):
    ...
    instructors = models.ManyToManyField(CourseInstructor, related_name="courses")
    topics = models.ManyToManyField(CourseTopic, related_name="courses")
    prices = models.ManyToManyField(CoursePrice, related_name="courses")
