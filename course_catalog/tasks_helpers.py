...
def parse_mitx_json_data(course_data, force_overwrite=False):
    ...
    for course_run in course_data.get("course_runs"):
        ...
        course_fields = {
            ...
            "image_src": ((course_run.get("image") or {}).get("src") or
                          (course_data.get("image") or {}).get("src")),
            "image_description": ((course_run.get("image") or {}).get("description") or
                                  (course_data.get("image") or {}).get("description")),
