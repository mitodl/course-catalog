...
from course_catalog.utils import webpack_dev_server_url
from course_catalog.templatetags.render_bundle import render_bundle, public_path
...
class TestRenderBundle(TestCase):
    ...
    def test_debug(self):
        ...
        with patch('course_catalog.templatetags.render_bundle.get_loader', return_value=loader) as get_loader:
